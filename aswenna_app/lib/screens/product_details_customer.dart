...
//---------------------- Detail Page -----------------------
class ProductDetailPageCustomer extends StatefulWidget {
  final DocumentSnapshot proData;

  ProductDetailPageCustomer({this.proData});

  @override
  _ProductDetailPageCustomerState createState() =>
      _ProductDetailPageCustomerState();
}

class _ProductDetailPageCustomerState extends State<ProductDetailPageCustomer> {
  @override
...
class ProductImages extends StatefulWidget {
  ...
  final ProductDetailPageCustomer widget;
