...
class FarmerProductsVegetable extends StatefulWidget {
  @override
  _FarmerProductsVegetableState createState() =>
      _FarmerProductsVegetableState();
}

class _FarmerProductsVegetableState extends State<FarmerProductsVegetable> {
  var _dataVegetable;
  getDataVegetable() {
    print(userIdGlobal);
