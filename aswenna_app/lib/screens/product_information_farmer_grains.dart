...
class FarmerProductsGrain extends StatefulWidget {
  @override
  _FarmerProductsGrainState createState() => _FarmerProductsGrainState();
}

class _FarmerProductsGrainState extends State<FarmerProductsGrain> {
  var _dataGrain;
  getDataGrain() {
    var streamGrain = FirebaseFirestore.instance
        .collection('sales')
        .where('type', isEqualTo: 'gra')
